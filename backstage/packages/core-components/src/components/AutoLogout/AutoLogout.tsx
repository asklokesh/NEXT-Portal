...
export const AutoLogout = (props: AutoLogoutProps): JSX.Element | null => {
 ...
 throw new Error(
 'ERROR: idleTimeoutMinutes property should be >= 0.5 minutes (30 seconds).',
 );
 }

 if (promptBeforeIdleSeconds < 0) {
 throw new Error(
 'ERROR: promptBeforeIdleSeconds property should be >= 0 seconds. Set to 0 to disable the prompt.',
 );
 }

 if (idleTimeoutMinutes * 60 <= promptBeforeIdleSeconds) {
 throw new Error(
 `ERROR: promptBeforeIdleSeconds should be smaller than idleTimeoutMinutes`,
 );
 }
