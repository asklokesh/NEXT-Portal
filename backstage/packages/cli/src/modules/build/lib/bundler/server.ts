...
`),
  ...
  if (appBaseUrl && appBaseUrl === backendBaseUrl) {
    console.log(
      chalk.yellow(
        `Conflict between app baseUrl and backend baseUrl:
...
`,
  ...
  if (rspack) {
    console.log(
      chalk.yellow(`WARNING: Using experimental RSPack dev server.`),
    );
  }
  ...
  if (publicPaths) {
    console.log(
      chalk.yellow(
        `WARNING: The app /public entry point is an experimental feature that may receive immediate breaking changes.`,
      ),
    );
  }
    ...
    if (reactPkg.version.startsWith('16.')) {
      console.log(
        chalk.yellow(
          `
=============================================================================
 You are using React version 16, which is deprecated for use in Backstage. 
 Please upgrade to React 17 by updating your packages/app dependencies.    
=============================================================================
`,
        ),
      );
