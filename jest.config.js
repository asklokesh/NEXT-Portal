...
const customJestConfig = {
  ...
  testMatch: [
    ...
    // Note: tests/integration and tests/contracts excluded - require external infrastructure
  ],
  collectCoverageFrom: [
    'src/**/*.{js,jsx,ts,tsx}',
    '!src/**/*.d.ts',
  ...
  testPathIgnorePatterns: [
    ...
    // Integration and contract tests require external infrastructure (supertest, pact, vault)
  ...
  projects: [
    ...
    //   npm run test:integration (requires supertest, real services)
    //   npm run test:contracts (requires @pact-foundation/pact)
  ],
