...
const categories = [
  ...
  { id: 'infrastructure', name: 'Infrastructure', icon: Layers },
...
const mockPlugins: Plugin[] = [
  {
    ...
    dependencies: ['@backstage/core', '@octokit/rest'],
    size: '2.4 MB',
    license: 'Apache-2.0',
  ...
  },
  {
    ...
    dependencies: ['@backstage/core', '@kubernetes/client-node'],
    size: '3.1 MB',
    license: 'Apache-2.0',
  ...
  },
  {
    ...
    description: 'Integrate PagerDuty incidents and on-call schedules',
    category: 'monitoring',
    version: '0.8.3',
    author: { name: 'PagerDuty', verified: true },
    downloads: 87000,
    stars: 456,
    rating: 4.5,
    reviews: 123,
    tags: ['monitoring', 'incidents', 'on-call', 'alerting'],
    compatibility: { backstage: '>=1.15.0', node: '>=16.0.0' },
  ...
  },
  {
    ...
    description: 'Display code quality metrics and security analysis from SonarQube',
    category: 'security',
    version: '0.7.12',
    author: { name: 'SonarSource', verified: true },
    downloads: 134000,
    stars: 678,
    rating: 4.6,
    reviews: 234,
    tags: ['security', 'code-quality', 'static-analysis', 'testing'],
    compatibility: { backstage: '>=1.17.0', node: '>=16.0.0' },
    dependencies: ['@backstage/core', 'axios'],
    size: '2.1 MB',
    license: 'Apache-2.0',
  ...
  },
  {
    ...
    displayName: 'Grafana',
    description: 'Embed Grafana dashboards and alerts in your service catalog',
    category: 'monitoring',
    version: '0.9.5',
    author: { name: 'Grafana Labs', verified: true },
    downloads: 156000,
    stars: 892,
    rating: 4.8,
    reviews: 312,
    tags: ['monitoring', 'dashboards', 'metrics', 'observability'],
    compatibility: { backstage: '>=1.19.0', node: '>=18.0.0' },
    dependencies: ['@backstage/core', '@grafana/data'],
    size: '2.7 MB',
    license: 'Apache-2.0',
  ...
  },
  {
    ...
    description: 'View and manage AWS Lambda functions from Backstage',
    category: 'cloud',
    version: '2.3.1',
    author: { name: 'Roadie', verified: true },
    downloads: 67000,
    stars: 234,
    rating: 4.4,
    reviews: 89,
    tags: ['aws', 'lambda', 'serverless', 'cloud'],
    compatibility: { backstage: '>=1.16.0', node: '>=16.0.0' },
    dependencies: ['@backstage/core', 'aws-sdk'],
    size: '1.9 MB',
    license: 'Apache-2.0',
  ...
  {
    id: 'openai',
    name: '@backstage-community/plugin-openai',
    displayName: 'OpenAI Assistant',
    description: 'AI-powered code generation and documentation assistant',
    category: 'ai-ml',
    version: '0.3.0',
    ...
    rating: 4.7,
    reviews: 156,
    tags: ['ai', 'openai', 'gpt', 'code-generation', 'documentation'],
    compatibility: { backstage: '>=1.20.0', node: '>=18.0.0' },
    dependencies: ['@backstage/core', 'openai'],
    size: '1.2 MB',
    license: 'MIT',
  ...
  {
    id: 'terraform',
    name: '@backstage/plugin-terraform',
    displayName: 'Terraform',
    description: 'Manage Terraform workspaces and infrastructure as code',
    category: 'infrastructure',
    version: '0.6.8',
    author: { name: 'HashiCorp', verified: true },
    downloads: 98000,
    stars: 445,
    rating: 4.5,
    reviews: 167,
...
export default function MarketplacePage() {
  ...
  const handleUninstallPlugin = async (plugin: Plugin) => {
    ...
    setInstallingPlugin(null);
    toast.success(`${plugin.displayName} uninstalled successfully!`);
  };
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>{plugin.securityScore}%</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            {plugin.installed ? (
              ...
              >
                {installingPlugin === plugin.id ? 'Processing...' : 'Installed'}
              </Button>
            ) : (
              <Button
                size="sm"
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <h3 className="font-semibold">{plugin.displayName}</h3>
              {plugin.verified && (
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Discover and install plugins to extend your Backstage platform
        </p>
      </div>
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        setFilters(prev => ({ ...prev, installed: !!checked }))
                      }
                    />
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              Found {filteredPlugins.length} plugins
            </p>
          </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <Tabs defaultValue="overview">
                      ...
                      <Card>
                        <CardContent className="pt-6">
                          <div className="text-2xl font-bold">
                            {formatNumber(selectedPlugin.downloads)}
                          </div>
                      ...
                      <div className="flex gap-2">
                        {selectedPlugin.homepage && (
                          <Button variant="outline" size="sm" asChild>
                            <a href={selectedPlugin.homepage} target="_blank" rel="noopener">
                        ...
                        {selectedPlugin.repository && (
                          <Button variant="outline" size="sm" asChild>
                            <a href={selectedPlugin.repository} target="_blank" rel="noopener">
                        ...
                        {selectedPlugin.documentation && (
                          <Button variant="outline" size="sm" asChild>
                            <a href={selectedPlugin.documentation} target="_blank" rel="noopener">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <pre className="bg-muted p-4 rounded-md">
                          <code>npm install {selectedPlugin.name}</code>
                        </pre>
                      </div>
                      <div>
                        <h3 className="font-semibold mb-2">Install via yarn</h3>
                        <pre className="bg-muted p-4 rounded-md">
                          <code>yarn add {selectedPlugin.name}</code>
                        </pre>
                      </div>
                      <div>
                        ...
                        <ul className="space-y-1">
                          <li className="text-sm">
                            Backstage: {selectedPlugin.compatibility.backstage}
                          </li>
                          <li className="text-sm">
                            Node: {selectedPlugin.compatibility.node}
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1">
                        {selectedPlugin.dependencies.map(dep => (
                          <li key={dep} className="text-sm font-mono bg-muted px-2 py-1 rounded">
                            {dep}
                          </li>
                        ))}
                      </ul>
                  ...
                  <TabsContent value="reviews" className="space-y-4 mt-4">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <span className="text-3xl font-bold">{selectedPlugin.rating}</span>
                          <div>
                ...
                <div className="flex justify-end gap-2">
                  ...
                  {selectedPlugin.installed ? (
                    ...
                    >
                      {installingPlugin === selectedPlugin.id ? 'Processing...' : 'Uninstall Plugin'}
                    </Button>
                  ) : (
                    <Button
                      disabled={installingPlugin === selectedPlugin.id}
                    ...
                    >
                      {installingPlugin === selectedPlugin.id ? 'Installing...' : 'Install Plugin'}
                    </Button>
                  )}
                </div>
              </div>
