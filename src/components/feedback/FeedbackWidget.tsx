    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <Button
            className="fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full shadow-lg transition-all duration-200 hover:shadow-xl"
            size="icon"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                maxLength={200}
              />
              <div className="text-right text-xs text-gray-500">{formData.title.length}/200</div>
            </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setFormData((prev) => {
                            const { screenshot: _removed, ...rest } = prev;
                            return rest;
                          })
                        }
